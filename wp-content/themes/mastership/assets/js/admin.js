jQuery(document).ready(function($) {
    ...
    $( document ).on( 'click', '.widget_multi_add_field', mastership_widget_multi_add_field )
        .on( 'change', '.widget_multi_single_field', mastership_widget_multi_single_field )
        .on( 'click', '.widget_multi_remove_field', mastership_widget_multi_remove_field )

    function mastership_set_multi_add_field() {
    ...
    mastership_set_multi_add_field();
    
    function mastership_widget_multi_add_field(e) {
        ...
        e.preventDefault();
            ...
            mastership_widget_multi_write( $control );
    }

    function mastership_widget_multi_single_field() {
        var $control = $( this ).parents( '.widget_multi_input' );
        mastership_widget_multi_write( $control );
    }

    function mastership_widget_multi_remove_field(e) {
        e.preventDefault();
        var $this = $( this );
        var $control = $this.parents( '.widget_multi_input' );
        $this.parent().remove();
    ...
    function mastership_widget_multi_write( $element) {
    ...
    $(document).on("click", ".mastership-accordion", function (e) {
        e.preventDefault();
        var $button = $(this);

        $button.next('.mastership-panel').slideToggle();
    ...
    function mastership_contentTypeChange() {
    ...
    mastership_contentTypeChange();

    function mastership_widget_chosen() {
        $(".mastership-widget-chosen-select").chosen({
            width: "100%"
        });
    }
    mastership_widget_chosen();

    $(document).on('widget-updated widget-added', function(){

        // icon picker
        $('.mastership-icon-picker').each( function() {
