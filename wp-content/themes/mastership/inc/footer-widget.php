...
class Mastership_Footer_Widgets{
	 ...
	 * @var int
	 */
	protected $theme_prefix = 'mastership';
	...
	function footer_widgets_init() {
		...
		for ( $i = 1; $i <= $this->max_widgets; $i++ ) {
			register_sidebar( array(
				'name'          => sprintf( __( 'Footer Widget %d', 'mastership' ), $i ),
...
// Initialize.
$mastership_footer_widgets = new Mastership_Footer_Widgets();
