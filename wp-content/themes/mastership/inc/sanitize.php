...
if ( ! function_exists( 'mastership_sanitize_select' ) ) :
	/**
	 ...
	 */
	function mastership_sanitize_select( $input, $setting ) {
...
if ( ! function_exists( 'mastership_sanitize_number_range' ) ) :
	/**
	 ...
	 *                    the setting default.
	 */
	function mastership_sanitize_number_range( $number, $setting ) {
...
if ( ! function_exists( 'mastership_sanitize_page_post' ) ) :
	/**
	* Sanitizes page/post
	* @param  $input entered value
	* @return sanitized output
	*/
	function mastership_sanitize_page_post( $input ) {
		// Ensure $input is an absolute integer.
...
if( ! function_exists( 'mastership_sanitize_category' ) ) :
	/**
	 * Sanitizes dropdown single category
	 * @param  $input entered value
	 * @return sanitized output
	 */
	function mastership_sanitize_category( $input ) {
		if ( $input != '' ) {
			$args = array(
							'type'			=> 'post',
							'child_of'      => 0,
...
if ( ! function_exists( 'mastership_santize_allow_tags' ) ) :
	/**
	 ...
	 */
	function mastership_santize_allow_tags( $input ) {
...
if ( ! function_exists( 'mastership_sanitize_switch' ) ) :
	/**
	 * Sanitize data from custom Switch Control.
	 * @param  string $input 
	 * @return boolean    
	 */
	function mastership_sanitize_switch( $input ) {
