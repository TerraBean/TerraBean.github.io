 ...
 */
Class Mastership_Switch_Control extends WP_Customize_Control{
	public $type = 'switch';
 ...
 */
Class Mastership_Radio_Image_Control extends WP_Customize_Control {
 ...
 * @see WP_Customize_Control
 */
class Mastership_Dropdown_Chosen_Control extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <select class="mastership-chosen-select" <?php $this->link(); ?>>
                    <?php
 ...
 * @access public
 */
class Mastership_Customize_Section_Upsell extends WP_Customize_Section {
